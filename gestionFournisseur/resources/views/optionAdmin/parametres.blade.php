        ...
        <div class="bg-white py-10 sm:py-10">
            ...
            <div class="items-center flex justify-center grid grid-cols-3">
                <form method="post" action="{{ route('employes.store') }}" class="px-8 mb-4 col-start-2">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-solid border-2 border-blue-100 px-2 py-2 rounded-lg shadow-lg shadow-blue-100 bg-white focus:ring-blue-100" name="courrielAppro" value="approvisionnement@v3r.net" id="courrielAppro" type="text">
                        @error('courrielAppro')
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-2">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-solid border-2 border-blue-100 px-2 py-2 rounded-lg shadow-lg shadow-blue-100 bg-white focus:ring-blue-100" name="delai" value="24" id="delai" type="number">
                                @error('delai')
                                    <div class="mb-5 mt-2 text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-start-3 col-span-2">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-solid border-2 border-blue-100 px-2 py-2 rounded-lg shadow-lg shadow-blue-100 bg-white focus:ring-blue-100" name="delai" value="75"  id="delai" type="number">
                                @error('taille')
                                    <div class="mb-5 mt-2 text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-solid border-2 border-blue-100 px-2 py-2 rounded-lg shadow-lg shadow-blue-100 bg-white focus:ring-blue-100" name="courrielFin"  value="finances@v3r.net"  id="courrielFin" type="text">
