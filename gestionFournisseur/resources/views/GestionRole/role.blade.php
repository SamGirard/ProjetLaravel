    ...
    @section('contenu')
        <div class="bg-white py-24 sm:py-32">
                ...
                <div class="">
                @if (session('success'))
                    <div id="toast-success" class="flex items-center max-w-xs mb-3 text-gray-500 dark:text-gray-400" role="alert">
                        <div class="inline-flex items-center justify-center flex-shrink-0 w-8 text-green-500 dark:text-green-200">
                ...
                <div class="relative w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            <p class="text-xs text-orange-500 opacity-80">*Pour supprimer un administrateur, veuillez en ajouter un troisième</p>
                            <p class="text-xs text-orange-500 opacity-80">*Pour supprimer un responsable, veuillez en ajouter un deuxième</p>
                                ...
                                @if(count($employes))
                                    ...
                                    <li class="employe">
                                        <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                            <input name="employe[]" type="checkbox" value="{{$employe->courriel}}" id="employeSelect" data-role="{{ $employe->role }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500 checkbox-emp">
