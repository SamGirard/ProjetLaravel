    ...
    <ol role="list" class="divide-y divide-gray-300 rounded-md border border-gray-300 md:flex md:divide-y-0">
        <li class="relative md:flex md:flex-1">
            ...
            <a href="#" class="group flex w-full items-center">
              <span class="flex items-center px-6 py-4 text-sm font-medium">
                <span
                    class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full @if(Request::path()=="ajouter_service") bg-blue-500 @endif group-hover:bg-blue-700">
                 @if(Request::path()=="ajouter_service")
                ...
                <span class="ml-4 text-sm font-medium text-gray-900">Identification</span>
              </span>
            </a>
        ...
        <li class="relative md:flex md:flex-1">
            ...
            <a href="#" class="group flex w-full items-center">
                ...
                <span class="ml-4 text-sm font-medium text-blue-600">Produits et services offerts</span>
            </a>
            <!-- Arrow separator for lg screens and up -->
            <div class="absolute right-0 top-0 hidden h-full w-5 md:block" aria-hidden="true">
                <svg class="h-full w-full text-gray-300" viewBox="0 0 22 80" fill="none" preserveAspectRatio="none">
