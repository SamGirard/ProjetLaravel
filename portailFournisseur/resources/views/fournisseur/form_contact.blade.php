...
@section('content')
    ...
    <div class="container mx-auto mt-6">
        <form action="{{ route('store_contact') }}" method="post"
            ...
            @csrf
            <h1 class="text-3xl font-bold text-gray-900 mb-8 border-b-2 border-gray-300 pb-4">Contact</h1>
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div class="">
                    <div class="mb-4 flex justify-between border border-gray-200 rounded-lg p-6 bg-gray-50" >
                        <div>
                            <label for='type_telephone_contact' class="block text-lg text-gray-600 mb-2">Type</label>
                        ...
                        <div>
                            <label for="telephone_contact" class="block text-lg text-gray-600 mb-2">Telephone</label>
                            <div class="flex">
